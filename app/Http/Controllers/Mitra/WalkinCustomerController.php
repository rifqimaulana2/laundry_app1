...
class WalkinCustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('mitra.walkin-customers.index')->with('success', 'Pelanggan walk-in berhasil ditambahkan.');
    }
    ...
    public function update(Request $request, WalkinCustomer $walkinCustomer)
    {
        ...
        return redirect()->route('mitra.walkin-customers.index')->with('success', 'Pelanggan walk-in berhasil diperbarui.');
    }
    ...
    public function destroy(WalkinCustomer $walkinCustomer)
    {
        ...
        return redirect()->route('mitra.walkin-customers.index')->with('success', 'Pelanggan walk-in berhasil dihapus.');
    }
}