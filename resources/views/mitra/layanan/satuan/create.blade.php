...
@section('content')
    <div class="max-w-xl mx-auto mt-10">
        <div class="bg-white rounded-3xl shadow-lg p-8">
            <h1 class="text-2xl font-bold text-gray-800 mb-6">Tambah Layanan Satuan</h1>
            <form action="{{ route('mitra.layanan-satuan.store') }}" method="POST" class="space-y-5">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <input type="number" name="harga_per_item" class="w-full rounded-lg border-gray-300 focus:ring-green-500 focus:border-green-500 text-gray-800 py-2 px-3" required>
                </div>
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-700">Durasi Hari</label>
                    <input type="number" name="durasi_hari" class="w-full rounded-lg border-gray-300 focus:ring-green-500 focus:border-green-500 text-gray-800 py-2 px-3" required>
                </div>
