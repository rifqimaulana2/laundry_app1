...
<div class="max-w-xl mx-auto py-8">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Edit Status</h1>

    <form action="{{ route('superadmin.status-master.update', $statusMaster->id) }}" method="POST" class="bg-white p-6 rounded-xl shadow space-y-6">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input type="text" name="nama_status" id="nama_status"
                   ...
                   value="{{ old('nama_status', $statusMaster->nama_status) }}" required>
            @error('nama_status')
