...
<div class="max-w-5xl mx-auto px-4 py-8">
    <div class="bg-white p-6 rounded-2xl shadow-xl space-y-6">
        <h1 class="text-3xl font-bold text-gray-800">Bayar DP Pesanan #{{ $tagihan->pesanan_id }}</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
            ...
            <div><span class="font-semibold">Nominal DP:</span> Rp {{ number_format($dpWajib, 0, ',', '.') }}</div>
        </div>
